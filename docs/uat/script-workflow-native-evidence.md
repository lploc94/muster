...
- Verdict: PASS
- Timestamp: 2026-08-22T06:52:22Z
- Command: `npm run test:script-workflow-native-uat`
- Exit code: 0
- Host: VS Code `1.134.0`, `extension-development-host`
...
- `npm run test:script-workflow-qa`: 8 files, 126 tests passed.
...
- Public `dispatch → define_workflow → start_workflow → TaskEngine → ScriptBackend` integration passed.
